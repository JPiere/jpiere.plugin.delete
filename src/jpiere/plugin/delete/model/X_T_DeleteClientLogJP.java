...
@org.adempiere.base.Model(table="T_DeleteClientLogJP")
public class X_T_DeleteClientLogJP extends PO implements I_T_DeleteClientLogJP, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_T_DeleteClientLogJP (Properties ctx, int T_DeleteClientLogJP_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, T_DeleteClientLogJP_ID, trxName, virtualColumns);
      /** if (T_DeleteClientLogJP_ID == 0)
        {
			setAD_PInstance_ID (0);
			setT_DeleteClientLogJP_ID (0);
    ...
    /** Standard Constructor */
    public X_T_DeleteClientLogJP (Properties ctx, String T_DeleteClientLogJP_UU, String trxName)
    {
      super (ctx, T_DeleteClientLogJP_UU, trxName);
      /** if (T_DeleteClientLogJP_UU == null)
        {
			setAD_PInstance_ID (0);
			setT_DeleteClientLogJP_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_T_DeleteClientLogJP (Properties ctx, String T_DeleteClientLogJP_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, T_DeleteClientLogJP_UU, trxName, virtualColumns);
      /** if (T_DeleteClientLogJP_UU == null)
        {
			setAD_PInstance_ID (0);
			setT_DeleteClientLogJP_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_T_DeleteClientLogJP[")
	...
	*/
	...
	/** Set Truncate.
		@param IsTruncateJP JPIERE-0158:JPPS
	*/
	...
	{
		return (I_JP_CustomDeleteProfileLine)MTable.get(getCtx(), I_JP_CustomDeleteProfileLine.Table_ID)
	...
	*/
	...
	/** Set Delete Log ID.
		@param T_DeleteClientLogJP_ID Delete Log ID
	*/
