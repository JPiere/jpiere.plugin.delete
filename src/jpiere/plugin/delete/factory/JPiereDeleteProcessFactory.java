...
/**
 *
 * Factory of Delete Process
 *
 * @author Hideaki Hagiwara
 *
 */
public class JPiereDeleteProcessFactory implements IProcessFactory {

	private final static CLogger log = CLogger.getCLogger(JPiereDeleteProcessFactory.class);

	/**
	 * default constructor
	 */
	public JPiereDeleteProcessFactory() {
	}
	...
	public ProcessCall newProcessInstance(String className) {
		...
		if (className.startsWith("jpiere.plugin.delete.process"))
		{
